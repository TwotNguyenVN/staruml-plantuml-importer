...
if not errorlevel 1 (
    echo [*] StarUML is running. You can press Ctrl + R in StarUML to reload the extension after installation.
)
...
echo.
echo How to use:
echo   1. Open StarUML (or press Ctrl + R to reload if already open)
