...
| **State Diagram** (Biểu đồ trạng thái)    | ✅ Đã hỗ trợ  | Hỗ trợ đầy đủ composite state, orthogonal region, các trạng thái lồng nhau & chuyển trạng thái |
...
- Phân tích cú pháp PlantUML cho các biểu đồ Use Case, Class, Sequence, Activity, State, ERD và Mindmap.
