...
function showImportDialog(title, sampleCode) {
  ...
  var template = [
    ...
    '      <label style="font-weight: 600; margin-bottom: 8px; color: #a0a0a0; font-size: 11px; text-transform: uppercase; letter-spacing: 0.5px; font-family: sans-serif;">PlantUML Code</label>',
    '      <textarea class="plantuml-code-input" style="flex: 1; font-family: \'Consolas\', \'Monaco\', \'Courier New\', monospace; font-size: 13px; resize: none; padding: 12px; line-height: 1.5; margin-bottom: 12px; background: #181818; color: #d4d4d4; border: 1px solid #3a3a3a; border-radius: 6px; outline: none; box-shadow: inset 0 1px 3px rgba(0,0,0,0.3); transition: border-color 0.2s;" placeholder="Type PlantUML code here...">' + sampleCode + '</textarea>',
    '      <div style="display: flex; justify-content: flex-end;">',
    '        <button class="btn btn-clear-code" style="padding: 6px 14px; background: #2d2d2d; color: #ccc; border: 1px solid #3c3c3c; border-radius: 4px; cursor: pointer; font-size: 12px; font-weight: 500; font-family: sans-serif; transition: background 0.2s;">Clear Code</button>',
    '      </div>',
    '    </div>',
    ...
    '    </div>',
    '  </div>',
    '  <div class="modal-footer" style="padding: 12px 20px; display: flex; justify-content: flex-end; align-items: center; gap: 10px; border-top: 1px solid #3c3c3c; background: #282828;">',
