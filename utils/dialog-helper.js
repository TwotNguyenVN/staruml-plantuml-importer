...
function showImportDialog(title, sampleCode) {
  ...
  var template = [
    ...
    '        <label style="font-weight: 600; margin: 0; color: #a0a0a0; font-size: 11px; text-transform: uppercase; letter-spacing: 0.5px; font-family: sans-serif;">PlantUML Code</label>',
    '        <button class="btn btn-clear-code" style="padding: 3px 10px; background: #2d2d2d; color: #ccc; border: 1px solid #3c3c3c; border-radius: 4px; cursor: pointer; font-size: 11px; font-weight: 500; font-family: sans-serif; transition: background 0.2s;" title="Clear input code">Clear</button>',
    '      </div>',
